...
/**
 * Adds a widget that can show the latest posts from any given category.
 */
...
class Latest_Posts_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			'latests_posts_widget', // Base ID
			'Senaste inläggen - kategoribaserad', // Name
			array( 'description' => 'Visar de senaste inläggen från en specifik kategori.', ) //Args
		);
	}
	...
	public function form($instance) {
		...
		<?php /*<p>
			<label for="<?php echo $this->get_field_name('category'); ?>">Kategori:</label>
